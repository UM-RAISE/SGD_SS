...
# imperfectSave = "im1000TrainSSGDCART.csv"


testLoad = "1000TestData.csv"
trainLoad = "1000TrainData.csv"
imperfectSave = "im1000TrainSSGDCARTEx1NoResample.csv"
perfectSave = "p1000TrainSSGDCARTEx1NoResample.csv"
...
directFindLocal1SGDnonAdap <- function(data, start){
  ...
  newList <- list("thetaChoice" = thetaChoice, "sampleSize" = sampleSize, "proportion" = samNumSeqM, "paras" = paras1, "iters" = actualIter, wTrend = samNumSeqM)
  return (newList)
}
